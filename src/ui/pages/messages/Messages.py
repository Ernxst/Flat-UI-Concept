...
class Messages(MenuPage):
    ...
    def _show_chat_preview(self):
        self._content.add(self._contact_frame, row=0, column=0, sticky='nesw', padx=(20, 0), pady=(10, 20))
        self._show_entry()
    ...
    def _show_chat(self):
        self._content.add(self._chat_frame, row=0, column=1, sticky='nesw', padx=(0, 20), pady=(10, 20))
