...
from util.constants import BLANK, MAX_EVENT_DESC_LENGTH, APP_FONT, GREEN, LIGHT_GREEN
...
class EventsButton(FrameButton):
    ...
    def _show(self):
        ...
        self._month_lbl.grid(row=2, column=0, sticky='nesw')
